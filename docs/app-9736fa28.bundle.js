...
var auth = _interopRequireWildcard(__webpack_require__(410));

exports.auth = auth;

var db = _interopRequireWildcard(__webpack_require__(411));

exports.db = db;

var firebase = _interopRequireWildcard(__webpack_require__(74));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Provider__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_connectAdvanced__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(380);
...
var firebase = _interopRequireWildcard(__webpack_require__(89));
...
var _common = _interopRequireDefault(__webpack_require__(417));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(379);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(392);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(23), __webpack_require__(391)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(136);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_change_emitter__ = __webpack_require__(420);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_symbol_observable__ = __webpack_require__(132);
...
var _store = _interopRequireDefault(__webpack_require__(400));

var _App = _interopRequireDefault(__webpack_require__(405));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(396);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(397);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(398);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(399);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
var _reducers = _interopRequireDefault(__webpack_require__(401));
...
var _session = _interopRequireDefault(__webpack_require__(402));

var _user = _interopRequireDefault(__webpack_require__(403));

var _budget = _interopRequireDefault(__webpack_require__(404));
...
var applySetBudgetYear = function applySetBudgetYear(state, action) {
  return Object.assign({}, state, {
    budgetYear: action.budgetYear
  });
};

var applySetBudgetMonth = function applySetBudgetMonth(state, action) {
  return Object.assign({}, state, {
...
var _Header = _interopRequireDefault(__webpack_require__(406));

var _Landing = _interopRequireDefault(__webpack_require__(413));

var _SignUp = _interopRequireDefault(__webpack_require__(416));

var _MyBudget = _interopRequireDefault(__webpack_require__(419));

var _SignIn = _interopRequireDefault(__webpack_require__(427));

var _ForgotPassword = _interopRequireDefault(__webpack_require__(429));

var _withAuthentication = _interopRequireDefault(__webpack_require__(432));

var routes = _interopRequireWildcard(__webpack_require__(22));

var _App = _interopRequireDefault(__webpack_require__(433));
...
var _Header = _interopRequireDefault(__webpack_require__(407));

var _moolahlah_text_only = _interopRequireDefault(__webpack_require__(408));

var _Navigation = _interopRequireDefault(__webpack_require__(409));
...
var _Navigation = _interopRequireDefault(__webpack_require__(412));
...
var _firebase = __webpack_require__(74);
...
var _LandingPage = _interopRequireDefault(__webpack_require__(414));

var _landing = _interopRequireDefault(__webpack_require__(415));
...
var _SignUp = _interopRequireDefault(__webpack_require__(418));
...
var _recompose = __webpack_require__(137);

var _firebase = __webpack_require__(21);

var _withAuthorization = _interopRequireDefault(__webpack_require__(421));

var _BudgetMonthSelector = _interopRequireDefault(__webpack_require__(422));

var _MyBudget = _interopRequireDefault(__webpack_require__(426));
  ...
  _createClass(MyBudgetPage, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: _MyBudget.default.left
      }, _react.default.createElement("h1", {
        className: _MyBudget.default.welcome
      }, "Hello, ", displayName, "!")), _react.default.createElement("section", {
        className: _MyBudget.default.right
      }, _react.default.createElement(_BudgetMonthSelector.default, null), _react.default.createElement("hr", null)));
    }
  }]);
...
var _BudgetMonthSelector = _interopRequireDefault(__webpack_require__(425));
...
var BudgetMonthSelector =
/*#__PURE__*/
function (_Component) {
  _inherits(BudgetMonthSelector, _Component);

  function BudgetMonthSelector(props) {
    var _this;

    _classCallCheck(this, BudgetMonthSelector);

    _this = _possibleConstructorReturn(this, (BudgetMonthSelector.__proto__ || Object.getPrototypeOf(BudgetMonthSelector)).call(this, props));
    _this.state = {
  ...
  _createClass(BudgetMonthSelector, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _props = this.props,
          budgetYear = _props.budgetYear,
          budgetMonth = _props.budgetMonth,
          setBudgetYear = _props.setBudgetYear,
          setBudgetMonth = _props.setBudgetMonth;
    ...
    key: "render",
    value: function render() {
      var monthsShort = this.state.monthsShort;
      var _props2 = this.props,
          budgetYear = _props2.budgetYear,
          budgetMonth = _props2.budgetMonth,
          setBudgetYear = _props2.setBudgetYear,
          setBudgetMonth = _props2.setBudgetMonth;
      var prevYear = (+budgetYear - 1).toString();
      var nextYear = (+budgetYear + 1).toString();
      return _react.default.createElement("div", {
        className: _BudgetMonthSelector.default.container
      }, _react.default.createElement("div", {
        className: _BudgetMonthSelector.default.topbar
      }, _react.default.createElement("h1", {
        className: _BudgetMonthSelector.default.month
      }, budgetMonth, _react.default.createElement("span", null, budgetYear)), _react.default.createElement("ul", {
        className: _BudgetMonthSelector.default.yearBtnGroup
      }, _react.default.createElement("li", null, _react.default.createElement("button", {
        onClick: function onClick() {
          return setBudgetYear(prevYear);
        }
      }, prevYear)), _react.default.createElement("li", {
        className: _BudgetMonthSelector.default.tag
      }, budgetYear), _react.default.createElement("li", null, _react.default.createElement("button", {
        onClick: function onClick() {
          return setBudgetYear(nextYear);
        }
      }, nextYear)))), _react.default.createElement("div", {
        className: _BudgetMonthSelector.default.select
      }, monthsShort.map(function (month) {
        var btnMonth = (0, _moment.default)(month, 'MMM').format('MMMM');
        var s = _BudgetMonthSelector.default.monthBtn;
        s += btnMonth === budgetMonth ? " ".concat(_BudgetMonthSelector.default.active) : '';
        return _react.default.createElement("button", {
          className: s,
          key: month,
          onClick: function onClick() {
            return setBudgetMonth(btnMonth);
          }
        }, _react.default.createElement("span", null, month));
      })));
    }
  }]);

  return BudgetMonthSelector;
}(_react.Component);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    setBudgetYear: function setBudgetYear(budgetYear) {
      return dispatch({
        type: 'SET_BUDGET_YEAR',
        budgetYear: budgetYear
      });
    },
    setBudgetMonth: function setBudgetMonth(budgetMonth) {
      return dispatch({
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(BudgetMonthSelector);
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"-BudgetMonthSelector-container-sUhTdl-","topbar":"-BudgetMonthSelector-topbar-rxb0-T-","month":"-BudgetMonthSelector-month-2YWfO2-","select":"-BudgetMonthSelector-select-3ZlgFJ-","monthBtn":"-BudgetMonthSelector-monthBtn-2w9eSU-","active":"-BudgetMonthSelector-active-3XFzs6-","yearBtnGroup":"-BudgetMonthSelector-yearBtnGroup-2raFij-","tag":"-BudgetMonthSelector-tag-2mvwVU-"};
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"-MyBudget-container-25emxy-","left":"-MyBudget-left-2GYvGp-","welcome":"-MyBudget-welcome-1cyBHx-","right":"-MyBudget-right-3wzxVK-"};
...
var _SignIn = _interopRequireDefault(__webpack_require__(428));
...
var _sweetalert = _interopRequireDefault(__webpack_require__(430));

var _ForgotPassword = _interopRequireDefault(__webpack_require__(431));
...
//# sourceMappingURL=app-9736fa28.bundle.js.map