...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(20), __webpack_require__(270)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_change_emitter__ = __webpack_require__(297);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_symbol_observable__ = __webpack_require__(129);
...
var _reactDom = _interopRequireDefault(__webpack_require__(73));

var _reactRedux = __webpack_require__(31);

var _store = _interopRequireDefault(__webpack_require__(279));

var _App = _interopRequireDefault(__webpack_require__(283));
...
var _reducers = _interopRequireDefault(__webpack_require__(280));
...
var _session = _interopRequireDefault(__webpack_require__(281));

var _user = _interopRequireDefault(__webpack_require__(282));
...
var _Header = _interopRequireDefault(__webpack_require__(284));

var _LandingPage = _interopRequireDefault(__webpack_require__(289));

var _SignUp = _interopRequireDefault(__webpack_require__(292));

var _MyBudget = _interopRequireDefault(__webpack_require__(296));

var _withAuthentication = _interopRequireDefault(__webpack_require__(300));

var routes = _interopRequireWildcard(__webpack_require__(32));

var _App = _interopRequireDefault(__webpack_require__(301));
...
var _moolahlah_text_only = _interopRequireDefault(__webpack_require__(286));

var _Navigation = _interopRequireDefault(__webpack_require__(287));
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"-Navigation-container-1QYlzS-","link":"-Navigation-link-Ntl35P-","active":"-Navigation-active-3hAr4X-"};
...
var _LandingPage = _interopRequireDefault(__webpack_require__(290));

var _landing = _interopRequireDefault(__webpack_require__(291));
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"-LandingPage-container-2z-Roy-","landingImg":"-LandingPage-landingImg-1j5NYW-","snippet":"-LandingPage-snippet-1X12ji-","signup":"-LandingPage-signup-34YAWs-"};
...
var FormInput = function FormInput(props, _ref3) {
  var bubbleState = _ref3.bubbleState;
  ...
  return _react.default.createElement(_react.Fragment, null, _react.default.createElement("label", {
    ...
    className: _SignUp.default.label
    ...
    id: propertyName,
    className: _SignUp.default.input,
    autoComplete: "off"
  }));
};
...
function (_Component) {
  ...
  _createClass(SignUpForm, [{
    ...
    value: function getChildContext() {
      ...
      return {
        bubbleState: function bubbleState(propertyName, value) {
          _this2.setState(byPropKey(propertyName, value));
        }
      };
    }
  }, {
    ...
    value: function onSubmit(event) {
      ...
      _firebase.auth.doCreateUserWithEmailAndPassword(email, passwordOne).then(function (authUser) {
        _firebase.db.doCreateUser(authUser.uid, displayName).then(function () {
          ...
          _this3.setState(byPropKey('error', error));
        });
      }).catch(function (error) {
        _this3.setState(byPropKey('error', error));
      });
    ...
    value: function render() {
      ...
      }, _react.default.createElement(FormInput, {
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"-SignUp-container-1uHW05-","label":"-SignUp-label-1PzkMK-","input":"-SignUp-input-EG-xPr-","error":"-SignUp-error-1LxJFX-","actions":"-SignUp-actions-OJuSW1-","signup":"-SignUp-signup-5ne7WC-"};
...
var _recompose = __webpack_require__(134);

var _firebase = __webpack_require__(45);

var _withAuthorization = _interopRequireDefault(__webpack_require__(298));

var _MyBudget = _interopRequireDefault(__webpack_require__(299));
...
/*#__PURE__*/
function (_Component) {
  _inherits(MyBudget, _Component);

  function MyBudget() {
    _classCallCheck(this, MyBudget);

    return _possibleConstructorReturn(this, (MyBudget.__proto__ || Object.getPrototypeOf(MyBudget)).apply(this, arguments));
  }

  _createClass(MyBudget, [{
...
var _default = (0, _recompose.compose)((0, _withAuthorization.default)(authCondition), (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps))(MyBudget);
...
exports.SIGN_UP = exports.MY_BUDGET = exports.SIGN_IN = exports.LANDING = void 0;
var LANDING = '/';
...
var auth = _interopRequireWildcard(__webpack_require__(293));

exports.auth = auth;

var db = _interopRequireWildcard(__webpack_require__(294));

exports.db = db;

var firebase = _interopRequireWildcard(__webpack_require__(72));
...
var firebase = _interopRequireWildcard(__webpack_require__(86));
...
//# sourceMappingURL=app-cc0b6c64.bundle.js.map